...
import com.rance.chatui.ui.fragment.TtsSettings;
...
public class TtsDemo extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//Activity传值 ((EditText) findViewById(R.id.tts_text)).setText(R.string.text_tts_source);
        Intent i = getIntent();
        ((EditText) findViewById(R.id.tts_text)).setText(i.getStringExtra("answer"));
	}
	...
	public void onClick(View view) {
	    Log.d(TAG, "要翻译的文字: "+ ((EditText) findViewById(R.id.tts_text)).getText());
		if( null == mTts ){
