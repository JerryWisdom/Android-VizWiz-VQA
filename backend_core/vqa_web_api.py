...
class QandA(db.Model):
    ...
    __tablename__ = 'ques_ans'    #表vqaHistory建立了索引且增加了自增主键recordId
...
'''
路由函数,与PC端Web网站的react-axios交互，安卓和小程序端则运行Android_flaskWeb.py作为后端
'''
...
def login():
    #  request.args.get() 获取Get请求参数, request.form.get() 获取post请求
